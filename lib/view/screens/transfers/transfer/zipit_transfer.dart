...
class ZIPITTransfersScreen extends StatefulWidget {
  const ZIPITTransfersScreen({super.key});

  @override
  State<ZIPITTransfersScreen> createState() =>
      _ZIPITTransfersScreenState();
}

class _ZIPITTransfersScreenState extends State<ZIPITTransfersScreen> {
